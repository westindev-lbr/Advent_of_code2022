...
import { convertStringToNumberArray, countTreeVisible, createMatriceOfTree, initTreesOnEdges, Tree, updateTreeVisible, visibilityFromTree } from './script';
