...
export function convertStringToNumberArray(array: number[][], content: string) {
 ...
 */
export function createMatriceOfTree(array: number[][]): Tree[][] {
 ...
 */
export function initTreesOnEdges(treeArray: Tree[][]) {
 ...
 * @param treeArray : Tableau 2D de type Tree
 */
export function updateTreeVisible(treeArray: Tree[][]) {
    let count = 1;
...
export function visibilityFromTree(treeArray: Tree[][], i: number, j: number) {
...
export function scanVisibilityFromAllOfTrees(treeArray: Tree[][]){
    let bestTreeView = 0;
    for (let i = 1; i < treeArray.length -1; i++) {
        for (let j = 1; j < treeArray.length -1; j++) {
 ...
 */
export function countTreeVisible(treeArray: Tree[][]) {
    let result = 0;
